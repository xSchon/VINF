...
class TestSearcher(unittest.TestCase):
    ...
    def test_slovak_search(self):
        ...
        response = self.searcher.search_index(
            fields_to_search=["BirthCountry"],
            queries=["Slovakia"],
            results_amount="All",
            printable_cols=["PlayerName"],
        )
    ...
    def test_fico_neon(self):
        ...
        response = self.searcher.search_index(
            fields_to_search=["CountryInfo", "InfoBox"],
            queries=["Fico", "Fico"],
            results_amount="All",
            printable_cols=["BirthCountry"],
        )
    ...
    def test_sports_relation(self):
        ...
        response = self.searcher.search_index(
            fields_to_search=["BirthCountry", "Sports"],
            queries=["Czech", "Ice Hockey"],
            results_amount="All",
            printable_cols=["PlayerName"],
            search_type="AND",
        )
    ...
    def test_long_g2_bot_query(self):
        ...
        response = self.searcher.search_index(
            ...
            queries=["22.0", "Lucian", "G2", "Worlds", "Bot"],
            results_amount="All",
            printable_cols=["PlayerName"],
            search_type="AND",
        )
